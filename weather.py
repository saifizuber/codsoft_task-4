...
#funtion for print weather forecasting in application
def data_get():
    city = com.get() 
    print(city)
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=3d2ddeda0084307208c1b2a2d655cdfb").json()
    print(data)
    w_label1.config(text=data["weather"][0]["main"])
    wb_label1.config(text=data["weather"][0]["description"])
    temp_label1.config(text=(int(data["main"]["temp"]-275.15)))
...
temp_label = Label(win,text="Temprature", font=("Time New Roman",17))
temp_label.place(x=25,y=400,height=50,width=210)
temp_label1 = Label(win,text="", font=("Time New Roman",17))
temp_label1.place(x=250,y=400,height=50,width=210)

p_label = Label(win,text="Pressure", font=("Time New Roman",17))
p_label.place(x=25,y=470,height=50,width=210)
p_label1 = Label(win,text="", font=("Time New Roman",17))
